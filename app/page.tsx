...
export default function Home() {
  ...
  const jsonLd = {
    ...
    "name": "Lion Mobilindo Malang",
    "image": "https://lionmobilindo.com/images/hero-bg.png",
    "@id": "https://lionmobilindo.com",
    "url": "https://lionmobilindo.com",
    "telephone": "+6282151140050",
    "priceRange": "Rp 100.000.000 - Rp 1.000.000.000",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Jl. Brigjend Slamet Riadi No.175 A, Oro-oro Dowo, Kec. Klojen",
    ...
    "sameAs": [
      "https://www.instagram.com/lionmobilindo_mlg"
    ]
  };
        ...
        <section id="home" className="relative min-h-screen pt-24 md:pt-0 flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="Background showroom mobil premium Lion Mobilindo Malang"
              fill
          ...
          <div className="container mx-auto px-6 relative z-10 text-center md:text-left">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-zinc-300 mb-10 max-w-2xl leading-relaxed">
                ...
                dan Tukar Tambah dengan proses cepat, transparan, dan aman di Lion Mobilindo Malang.
              </p>
              ...
              <div className="relative">
                <div className="aspect-[4/5] bg-zinc-900 rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Koleksi mobil bekas berkualitas di Lion Mobilindo Malang"
                    fill
              ...
              {featuredCars.map((car) => (
                ...
                >
                  <div className="relative aspect-video overflow-hidden">
                    <Image
                      src={car.image}
                      alt={`${car.name} - Mobil bekas berkualitas di Malang`}
                      fill
        ...
        <section className="py-24 bg-dark-surface overflow-hidden">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                { text: "Pelayanan sangat ramah and transparan. Unit Fortuner yang saya beli kondisinya seperti baru. Proses kreditnya benar-benar cepat!", author: "Bapak Setiawan - Malang" },
                ...
                <figure key={i} className="glass p-12 rounded-3xl border-white/5 group hover:border-accent-gold/20 transition-luxury">
                  <div className="flex text-accent-gold mb-6 text-xl">★★★★★</div>
                  <blockquote className="text-lg text-zinc-300 italic mb-8 leading-relaxed">"{item.text}"</blockquote>
                  <figcaption className="font-bold text-accent-gold uppercase tracking-widest text-sm">— {item.author}</figcaption>
                </figure>
              ))}
            </div>
          </div>
        ...
        <section className="bg-black">
          <div className="grid md:grid-cols-2">
            ...
            <div className="h-[400px] md:h-auto min-h-[500px]">
              <iframe
                title="Lokasi Lion Mobilindo Malang"
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-20">
            ...
            <div>
              ...
              <ul className="space-y-4 text-zinc-500 text-sm">
                ...
                <li><a href="https://www.instagram.com/lionmobilindo_mlg" target="_blank" rel="noopener noreferrer" className="hover:text-accent-gold">@lionmobilindo_mlg</a></li>
              </ul>
            </div>
          </div>
          <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-white/5 gap-6">
            <p className="text-zinc-600 text-sm">© {new Date().getFullYear()} Lion Mobilindo Malang. All rights reserved.</p>
